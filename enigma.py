...
class eGauge(eWidget):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        _enigma.eGauge_swiginit(self,_enigma.new_eGauge(*args))
...
eEPGCache.readXmltv = new_instancemethod(_enigma.eEPGCache_readXmltv,None,eEPGCache)
eEPGCache.Nab_reset_timer = new_instancemethod(_enigma.eEPGCache_Nab_reset_timer,None,eEPGCache)
